...
public class Disco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setBackground(new java.awt.Color(0, 75, 200));
        ...
        panelHome.add(lblTitulo3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, 70));
        ...
        jLabel10.setText("Espaço Disponível:");
        ...
        panelHome.add(lblTitulo4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, -1, -1));
        ...
        panelHome.add(lblTitulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, -1, -1));
        ...
        lblDisponivel.setFont(new java.awt.Font("Trebuchet MS", 0, 24)); // NOI18N
        lblDisponivel.setForeground(new java.awt.Color(255, 255, 255));
        lblDisponivel.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        panelAtividade.add(lblDisponivel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 300, 70));

        panelHome.add(panelAtividade, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 250, 330, 70));
        ...
        panelSistema2.add(lblTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 300, 70));

        panelHome.add(panelSistema2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 30, 330, 70));
        ...
        lblEmUso.setFont(new java.awt.Font("Trebuchet MS", 0, 24)); // NOI18N
        lblEmUso.setForeground(new java.awt.Color(255, 255, 255));
        lblEmUso.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        panelArquitetura.add(lblEmUso, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 300, 70));

        panelHome.add(panelArquitetura, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 140, 330, 70));

        pgBarDisco.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        pgBarDisco.setForeground(new java.awt.Color(4, 30, 84));
        pgBarDisco.setStringPainted(true);
        panelHome.add(pgBarDisco, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 390, 660, 70));
    ...
    public void informacoesDisco() {
        ...
        lblTotal.setText(dadosDisco.getStrDiscoTotalGb());
        
        lblEmUso.setText(dadosDisco.getStrDiscoUsadoGb());
        
        lblDisponivel.setText(dadosDisco.getStrDiscoDispGb());
